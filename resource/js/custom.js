...
$(document).ready(function(){
    ...
    $(".slide#first").backstretch(basePath+"resource/images/bg1.jpg");
    $(".slide#sec").backstretch(basePath+"resource/images/bg2.jpg");
    $(".slide#thirth").backstretch(basePath+"resource/images/bg4.jpg");
    $(".slide#fourth").backstretch(basePath+"resource/images/bg5.jpg");
